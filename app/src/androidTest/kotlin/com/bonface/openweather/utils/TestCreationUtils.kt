...
import com.bonface.openweather.domain.model.Clouds
import com.bonface.openweather.domain.model.Coord
...
import com.bonface.openweather.domain.model.FeelsLike
import com.bonface.openweather.domain.model.Main
import com.bonface.openweather.domain.model.Temp
import com.bonface.openweather.domain.model.Weather
...
object TestCreationUtils {
    ...
    fun getWeather(): WeatherEntity = WeatherEntity(
        id = 192126,
        name = "Kikuyu",
        latitude = -1.267,
        longitude = 36.695,
    ...
    private fun getDailyWeather(): List<DailyWeather> = listOf(
        DailyWeather(
